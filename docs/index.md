...
AI 驱动的每日信息聚合，自动抓取并筛选 GitHub、Hacker News、RSS 等技术资讯。

[搜索历史摘要 →]({{ '/search' | relative_url }})
...
AI-powered daily digest — automatically aggregates and filters tech news from GitHub, Hacker News, RSS, and more.

[Search archive →]({{ '/search' | relative_url }})
